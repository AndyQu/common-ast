...
public interface IntSet {
	 ...
	 *
	 * @param set
	 *            The set to add to the current set. A {@code null} argument is
	 ...
	 *
	 * @param a
	 *            The set to intersect with the current set. A {@code null}
	 *            argument is treated as though it were an empty set.
	 * @return A new {@link IntSet} instance containing the intersection of the
	 *         current set and {@code a}. The value {@code null} may be returned
	 *         in place of an empty result set.
	 */
	 ...
	 *
	 * @param elements
	 *            The set to compare with the current set. A {@code null}
	 *            argument is treated as though it were an empty set.
	 ...
	 *
	 * @param a
	 *            The set to union with the current set. A {@code null} argument
	 *            is treated as though it were an empty set.
	 * @return A new {@link IntSet} instance containing the union of the current
	 *         set and {@code a}. The value {@code null} may be returned in
	 ...
	 * @return {@code true} if the set contains {@code el}; otherwise
	 *         {@code false}.
	 */
